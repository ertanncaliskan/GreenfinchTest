...
using GreenfinchTest.BusinessLogic;
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (UserActionBL.AuthorizeUser(model))
            {
                ...
                SessionContainer.LoginSessions.Set<LoginInformation>(model.SessionId, new LoginInformation { LoginDate = DateTime.Now, UserName = UserActionBL.GetUserName(model.Email, model.Password) });
            }
            else {
        ...
        public ActionResult Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    Session["sessionId"] = model.SessionId;
                    SessionContainer.LoginSessions.Set<LoginInformation>(model.SessionId, new LoginInformation { LoginDate = DateTime.Now, UserName = model.UserName });
